    ...
    <footer>
      <div>
        <div className="compact">
          <div>
            <h4>Company</h4>
            <ul className="city-linkk">
              <li class="b-Hy9">
                <a class="_3TjLz" href="/about" alt="" >
                  About us
                </a>
              </li>
              <li class="b-Hy9">
                <a class="_3TjLz" href="/team" alt="" >
                  Team
                </a>
              </li>
              <li class="b-Hy9">
                <a class="_3TjLz" href="/careers" alt="" >
                  Careers
                </a>
              </li>
              <li class="b-Hy9">
          ...
          <div>
            ...
            <ul class="city-linkk">
              <li class="b-Hy9">
                <a class="_3TjLz" href="/support" alt="Help &amp; Support">
                  Help &amp; Support
                </a>
              </li>
              <li class="b-Hy9">
        ...
        <div>
          ...
          <ul class="city-linkk">
            ...
            <li class="b-Hy9">
              <a class="_3TjLz" href="/refund-policy" alt="" >
                Refund &amp; Cancellation
              </a>
            </li>
            <li class="b-Hy9">
              <a class="_3TjLz" href="/privacy-policy" alt="" >
                Privacy Policy
              </a>
            </li>
            <li class="b-Hy9">
              <a class="_3TjLz" href="/cookie-policy" alt="" >
                Cookie Policy
              </a>
            </li>
            <li class="b-Hy9">
              <a class="_3TjLz" href="/offer-terms" alt="" >
                Offer Terms
              </a>
            </li>
            <li class="b-Hy9">
            ...
            <li class="b-Hy9">
              <a class="_3TjLz" href="/tnc-corporate-sm" alt="" >
      ...
      <div id="s" class="RB8ET">
        <h4 class="T_dbb">WE DELIVER TO</h4>
        <div class="">
          <ul class="city-link">
            <li class="_2JILy">
      ...
      <div class="city-linkfoot">
        ...
        <div class="date">© 2023 Swiggy</div>
        <div class="fill">
          <a
            class="_1Az3W"
