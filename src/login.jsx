...
function Login() {
  ...
  const handleLoginClick = () => {
    setShowSideLogin(true);
  };
  return (
    <div className="master">
      <div className={`first-half ${showSideLogin ? "opacity" : ""}`}>
        <div className="header">
          <svg width="100" class="logo" viewBox="0 0 200 100">
          ...
          <div className="log">
            <Link className="login" onClick={handleLoginClick}>
              Login
            </Link>
            <Link
              className="sign" onClick={handleLoginClick}
            >
              Signup
            </Link>
          </div>
        ...
        <div className="detail">
          ...
          <p id="pid">Popular cities in india</p>
          <ul className="uid">
            <li>Ahmedabad</li>
            <li>Bangalore</li>
            <li>Chennai</li>
      ...
      <div className={`outmiddle ${showSideLogin ? "opacity" : ""}`}>
        <div className="middle">
          <div className="box1">
            ...
            <div id="name">No Minimum Order</div>
            <div>
          ...
          <div className="box1">
            ...
            <div id="name">Live Order Tracking</div>
            <div>
          ...
          <div className="box1">
            ...
            <div id="name">Lightning-Fast Delivery</div>
            <div>
      ...
      <div>
        <div className="outmiddle1">
          <div className="left">
            ...
            <div className="left2">
              <Link
                to="https://play.google.com/store/apps/details?id=in.swiggy.android"
                target="_blank"
              ...
              <Link
                to="https://itunes.apple.com/in/app/swiggy-food-order-delivery/id989540920"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
